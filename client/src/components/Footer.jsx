      ...
      <div className="max-w-7xl mx-auto px-4 py-16 grid grid-cols-1 md:grid-cols-4 gap-10">
        <div className="md:col-span-2">
          ...
          <div className="flex gap-4 mt-6">
            ...
            <a href="https://wa.me/212621010978" target="_blank" rel="noopener noreferrer" className="text-warmwhite/60 hover:text-gold transition-colors" aria-label="WhatsApp">
